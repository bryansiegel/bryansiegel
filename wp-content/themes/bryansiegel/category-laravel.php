<?php
/*
Template Name: Laravel Category
*/
...
<main id="content">
    ...
    <div class="container py-5 py-lg-6">
        <h1 class="display-3 pb-3">Laravel Projects</h1>
        <p><a href="https://laracasts.com/@bryansiegel" title="Bryan Siegel on Laracasts">@bryansiegel</a> on Laracasts</p>

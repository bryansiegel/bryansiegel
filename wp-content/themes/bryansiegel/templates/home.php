        ...
        <div class="container py-5">
            ...
            <div class="hp-icons">
                <a href="https://bitbucket.org/bryansiegel/" title="Bryan Siegel on Bitbucket">
                    <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2019/03/fav-bitbucket.png"
                        alt="My Old repos on Bitbucket" />
                </a>
                <a href="https://github.com/bryansiegel" alt="Bryan Siegel on Github">
                    <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2020/03/GitHub-Mark-Light-120px-plus.png"
                        alt="Bryan Siegel On Github">
                </a>
                <a href="https://twitter.com/BryanSiegel" title="Bryan Siegel on Twitter">
                    <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2019/03/twitter.png"
                        alt="Bryan Siegel  on Twitter" />
                </a>
                <a href="https://www.linkedin.com/in/bsiegel/" title="Bryan Siegel on LinkedIn">
                    <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2019/03/linkedin.png"
                        alt="Bryan Siegel on LinkedIn" />
                </a>
                <a href="<?php echo get_home_url(); ?>/contact" title="Contact Bryan Siegel">
                    <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2019/03/inbox.png"
                        alt="Contact Bryan Siegel" />
                </a>
            </div>
        </div>
            ...
            <ul class="row list-unstyled">
                <li class="col-md-6 mb-4">
                    <a href="<?php echo get_home_url(); ?>/category/Wordpress" title="Wordpress Projects">
                        <figure class="img-overlay">
                            <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2019/03/horizon-portfolio.png"
                                alt="Horizon Solar Power" class="border-dark img-thumbnail w-100 h-100"
                                alt="Horizon Solar Power">
                            <div class="img-hover">
                ...
                <li class="col-md-6 mb-4">
                    <a href="<?php echo get_home_url(); ?>/category/Laravel" title="Laravel Projects">
                        <figure class="img-overlay">
                            <img src="<?php echo get_home_url(); ?>/wp-content/uploads/2019/03/laravel-portfolio-1.png"
                                alt="Laravel Web Development" class="border-dark img-thumbnail w-100 h-100">
                ...
                <div class="row">
                    ...
                    <div class="container py-2">
                                ...
                                <div class="card border-0 mb-5">
                                    <div class="card-body">
                                        ...
                                        <div class="small text-muted mb-3">
                                            ...
                                            </a><span style="float:right;" class="card-title-green">by: <a
                                                    href="<?php echo get_home_url(); ?>/about">Bryan Siegel</a></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="text-center my-5">
                            <a href="<?php echo get_home_url(); ?>/blog" class="btn btn-outline-white"
                                title="View all Blog Posts">View all Blog Posts</a>
                        </div>
                    </div>
                    <!-- end posts -->
                </div>
